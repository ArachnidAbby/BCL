...
run: env/bin/activate
	./env/bin/python src/main.py compile tests/$(FILE)

run-dev: env/bin/activate
	./env/bin/python src/main.py compile tests/$(FILE) --dev

unittest: env/bin/activate
	./env/bin/python tests/Basic_Test.py

compile: env/bin/activate
	./env/bin/python -m nuitka --follow-imports src/main.py --include-data-dir=src/libbcl=src/libbcl
...
profile_cpu: env/bin/activate
	./env/bin/python -m cProfile -o tests/random/program.prof src/main.py hmmmm
